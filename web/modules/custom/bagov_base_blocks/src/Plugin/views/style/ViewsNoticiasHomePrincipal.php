 ...
 *
 * @ViewsStyle(
 *   id = "views_noticias_home_principal",
 *   title = @Translation("Notícias Home Principal"),
 *   help = @Translation("Displays rows in Notícias Home."),
 *   theme = "views_noticias_home_principal",
 *   theme_file = "../bagov_base_blocks.theme.inc",
 *   display_types = {"normal"}
 * )
 */
class ViewsNoticiasHomePrincipal extends StylePluginBase {
  /**
